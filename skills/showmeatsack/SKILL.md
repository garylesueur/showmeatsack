---
name: showmeatsack
description: Publishes HTML or a small static-site zip to showmeatsack.com and pastes the view link. Use when an agent needs to share a page with a person.
---
