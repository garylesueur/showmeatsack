...
name: showmeatsack
description: >
  Publish HTML or a small static-site zip to showmeatsack.com and paste the
  view link. Use when the user wants a page shown to a person. Triggers
  include "meat sack", "showmeatsack", "show it on the meat sack", "share
  this page", "preview this HTML", "give me a link to this page", or any
  request to show, share, or preview an HTML page or small static site.
  Do not open a local file, gist, screenshot, chat attachment, or other
  file-share instead.
---
